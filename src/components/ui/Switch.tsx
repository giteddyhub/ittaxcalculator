	...
	return (
		<label className="inline-flex items-center gap-3 cursor-pointer select-none">
			<span className="relative inline-flex h-5 w-9 items-center rounded-full transition-colors border border-gray-300 bg-gray-200 p-[2px] peer-checked:bg-blue-600/15 peer-checked:border-blue-600">
				...
				<span
					className="pointer-events-none inline-block h-4 w-4 rounded-full bg-white shadow-sm transition-all ml-0 peer-checked:ml-auto peer-checked:ring-2 peer-checked:ring-blue-600/25"
				/>
			</span>
